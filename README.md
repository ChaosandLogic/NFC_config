...
A small web app that writes a Wi-Fi **network name** and **password** to an NFC tag. That is all it does.
...
If NFC writing is not available (desktop, iPhone, other browsers), use **Show QR code**. Camera apps understand the same credentials.
